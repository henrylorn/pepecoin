...
// Copyright (c) 2016-2019 The PepeCoin Developers
...
*/
	...
	vSeeds.push_back(CDNSSeedData("seed.memetic.ai",  "seed.memetic.ai"));
	vSeeds.push_back(CDNSSeedData("seed.pepechain.app",  "seed.pepechain.app"));
